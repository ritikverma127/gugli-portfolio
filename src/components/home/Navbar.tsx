              ...
              <div className="w-full group-data-[state=active]:h-fit h-0 lg:w-fit flex-wrap justify-end items-center space-y-8 lg:space-y-0 lg:flex lg:h-fit md:flex-nowrap">
                <div className="mt-6 dark:text-body md:-ml-4 lg:pr-4 lg:mt-0">
                  <ul className="space-y-6 tracking-wide text-base lg:text-sm lg:flex lg:space-y-0">
                    ...
                    <li>
                      <a href="#feature" className="hover:link md:px-4 block">
                        <span>Feature</span>
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="#contact" className="hover:link md:px-4 block">
                        <span>Contact</span>
                      </a>
                    </li>
                  </ul>
            ...
            <div className="mx-auto px-6 max-w-7xl md:px-12">
              <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5 ">
                <a
                  ...
                  className="annonce border border-white rounded-3xl gap-2 !pr-1 sz-sm w-fit mx-auto group flex items-center  p-2"
                >
                  <span className="text-lg annonce-concern sz-xs variant-primary bg-purple-700 rounded-3xl pl-1 pr-1 ">
                    New
                  </span>
                  <span className="text-lg flex gap-6 ">
                    Gugli Tech
                ...
                <p className="text-wrap mx-auto mt-8 max-w-2xl text-lg hidden sm:block text-body">
                  From cutting-edge software development to robust IT solutions,
                  we transform ideas into reality for businesses worldwide.
                </p>
                <p className="text-wrap mx-auto mt-6 max-w-2xl sm:hidden text-body">
                  Highly customizable components for building modern websites
                  and applications, with your personal spark.
                </p>
                <div className="mt-8 flex flex-col items-center justify-center gap-4">
                  <div className=" ">
                    <button className="bg-violet-600 px-8 py-2 rounded-md flex items-center gap-2">
                      <a
                        href="/docs/installation"
                        className="btn variant-primary sz-lg flex"
                      >
                        <svg
                        ...
                        <span className="text-nowrap btn-label pl-2">
                          Start Building
                        </span>
                      </a>
                    </button>
